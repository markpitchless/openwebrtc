...
gcc tests/cocoon_client_std.c openwebrtc-deps-x86_64-linux/lib/libjson-glib-1.0.a openwebrtc-deps-x86_64-linux/lib/libsoup-2.4.a -o cocoon_client_std -I./out/x86_64-unknown-linux/include/owr -I ./openwebrtc-deps-x86_64-linux/include/glib-2.0/ -I ./openwebrtc-deps-x86_64-linux/include/json-glib-1.0/ -I ./openwebrtc-deps-x86_64-linux/include/libsoup-2.4/ -L ./out/x86_64-unknown-linux/./lib -lopenwebrtc
